...
import br.com.sigo.normas.dtos.CategoriaDTO;
...
public class CategoriaController {
  ...
  @Operation(summary = "Inserir/Atualizar categoria")
  @ApiResponses(value = {
  ...
  public ResponseEntity<Response<CategoriaDTO>> atualizarCategoria(@Valid @RequestBody CategoriaDTO dto) {
  ...
  public ResponseEntity<Response<Page<CategoriaDTO>>> listarCategoria() {
    return ResponseEntity.ok().build();
  }
